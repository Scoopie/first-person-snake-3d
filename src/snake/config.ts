...
export const FOOD_Y = 1.55;

export const FOOD_TYPES: Record<string, FoodType> = {
  bonus: { id: "bonus", label: "Bonus", word: "Bonus", color: 0xff4d4d, emissive: 0xff0000, points: 5, weight: 14 },
  slow: { id: "slow", label: "Slow", word: "Slow", color: 0x9fd3ff, emissive: 0x2299ff, points: 2, weight: 8 },
  fast: { id: "fast", label: "Fast", word: "Fast", color: 0xfff176, emissive: 0xffff00, points: 4, weight: 7 },
